...
public class Dataproviderdemo {
	...
	public Iterator<Object[]>  getTestData () {
		...
		//call the method--this funtions will return arraylist and store the arraylist under the testData 
	ArrayList <Object[]> testData = Reusablefunctionss.getTestDatafromExcel();
	//it will iterate one by one each row and return type will be Iterator 
	...
	public void traveldetails (String DepartFrom ,String ArrivingIn , String ArrivingOn ,String AirlinesRef ) {
		...
		WebElement toDay = driver.findElement(By.xpath("//select[@name='toDay']//option[contains(text(),ArrivingOn)]"));
		toDay.click();
